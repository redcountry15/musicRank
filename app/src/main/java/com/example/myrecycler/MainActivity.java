...
private DataAdapter songAdapter;
    String name [] = {"I Took A Pill in Ibiza","7 Years","Pillow Talk","Work From Home",
            "Never Forget You", "Don't Let Me Down","Love Yourself","Me,Myself&I","Cake by The Oceans",
            "Dangerous Woman","MyHouse","Stressed Out","One Dance","Middle","No"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);
            ...
            //biar posisi containernya gak berubah
            if(mRecyclerView!= null){
                mRecyclerView.setHasFixedSize(true);
            }
           //pake Layout buat nampung si listnya
        ...
        //Biar si songnya kepanggill kita buat looping

        for (int i =0;i<name.length; i++){

            Song song = new Song (name[i],singers[i],i+1,pics[i]);
            songList.add(song);

        }

        songAdapter = new DataAdapter(songList);
